                ...
                <div class="container"><div class="ic">More Website Templates at TemplateMonster.com!</div>
                    <div class="inside">
                         <div class="wrapper indent">
                            <article class="col-1">
                                <%  if(session.getAttribute("setalert")=="sucess"){%>
       <div class="box"  style="width:500px;background-color: #F0F0F0;" align="center">
       <h2 color="green">Alert has been set successfully</h2> 
       <%} else {%>
       <h2 color="red">Problem occurred while setting the alert</h2> <%}%>
<%--<jsp:forward page="notification.jsp"/>--%>
 <form name="form1" method="post"  action="notification.jsp">
<h3><input type="submit" align="right" class="blue button" style="width: 150px" value="Set More Alerts">   </h3>      

                            ...
                            <article class="col-1">
                                ...
                                <div id="tbltxt">
                                    ...
                                    <table class="bordered" border="1"  width ="650" style ="table-layout:fixed; border-collapse: collapse; text-align: center" >
                                        ...
                                        %>
                                        <tr>
                                            <td style ="word-wrap:break-word;" class="fid"><%= consultFiles.getConsultationId()%></td>
                                            <td style ="word-wrap:break-word;"class="pname"><%= consultFiles.getPatientId()%></td>
                                            <td style ="word-wrap:break-word;"class="pedate"><%=consultFiles.getPatientName()%></td>
                                            <td style ="word-wrap:break-word;"class="pedate"><%=consultFiles.getWhomConsulted()%></td>
                                            <td style ="word-wrap:break-word;"class="staffname"><%=consultFiles.getDateOfConsultation()%></td>
                                        </tr>
                                        <%
                                                }
                                            } else {

...
<html lang="en">
    <head>
	<title>TSRHC - Phone Management - Add New Success</title>
	<meta charset="utf-8">
                    ...
                    <div class="inside">
                        <div class="wrapper indent">
                            <article class="col-1">
                                ...
                                <h2>Success! You added the following Record:</h2>				
                                    
                                <table class="bordered">
                                    
                                    <tr>			
                                        <td><label for="fName"><h3>Patient First Name:</h3></label></td>                                            
                                        <td><p><%= session.getAttribute("firstName")%></p></td>
                                    </tr>
                                        
                                    <tr>			
                                        <td><label for="lName"><h3>Patient Last Name:</h3></label></td>                                            
                                        <td><p><%= session.getAttribute("lastName")%></p></td>
                                    </tr>
                                        
                                    <tr>
                                        <td><label for="DOB"><h3>Date of Birth:</h3></label></td>
                                        <td><p><%= session.getAttribute("birthday")%></p></td>
                                    </tr>
                                        
                                    <tr>			
                                        <td><label for="caller"><h3>Caller:</h3></label></td>
                                        <td><p><%= session.getAttribute("whocalled")%></p></td>
                                    </tr>
                                        
                                    <tr>
                                        <td><label for="ph_subject"><h3>Subject:</h3></label></td>
                                        <td><p><%= session.getAttribute("callSubj")%></p></td>
                                    </tr>    
                                        
                                    <tr>
                                        <td><label for="ph_body"><h3>Body:</h3></label></td>
                                        <td><p><%= session.getAttribute("callBody")%></p></td>
                                    </tr>
                                        
                                    <tr>
                                        <td><label for="pId"><h3>Patient ID:</h3></label></td>
                                        <td><p><%= session.getAttribute("PID")%></p></td>
                                    </tr>
                                    
                                    
                                </table>
                                   <form name="PhoneChooseNote" action="phoneEditSelector.jsp">
                                        <input type="submit" value="View Conversation" class="blue button" style="width: 160px"/>
                                    </form>
                                    
                                    <form name="PhoneChooseNote" action="phone.jsp">
                                        <input type="submit" value="<< Back " class="blue button" style="width: 160px"/>
                                    </form>
                            </article>

...
<%ILogger logger = Log4JLogger.GetLoggerObject();
     logger.LogMessage(session.getAttribute("user").toString(), "FileTrackingCheckIn.jsp", 
                        "searching file to check in");%>
...
<h2>Files Available for Check In</h2>
    ...
    <form name="filterResults" onsubmit="return validateSearchForm()" method="post" onsubmit="return validateForm()" action="SearchResult">

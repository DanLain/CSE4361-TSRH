...
ILogger logger = Log4JLogger.GetLoggerObject();
     logger.LogMessage(session.getAttribute("user").toString(), "FileTrackingResult.jsp", 
                        "to change the status of patient record");
...
<div class="mainPanel" onload="checkerpage()">
    ...
    <div class="panel" id="checkInDiv" <%=checkin%>>
        ...
        %>
        <form name="cinform" onsubmit="return validateCheckInForm()" method="post" action="CheckInFile">
            <table>
                <tr>
                    <td width="200"><h3>File returned by:<span style="color: red">*</span></h3></td>
                    <td width= "300">
                ...
                <tr>
                    <td><h3>Check-in Date:</h3></td>
                    <td>
                        <input type="radio" name="date" onClick="clickTodayCheckIn()" checked/> Now (or)
                        <input type="radio" name="date" onClick="clickCheckIn()"/>Specify Date:<br/><br/>
                        <div id="DateTimer" style="display: none">
                            <input type="text" readonly id="Checker" name ="Checker" value="" style="width:200px;"/>
                        </div>
                        <input id="fileId" name="fileId" type="hidden" value=<%= fileDetail.getFileID()%> />
                    </td>
                </tr>	
                <tr>
                    <td><h3>Location:<span style="color: red">*</span></h3></td>
                    <td>
                        <dl id="locationcombo" class="dropdown">
                            ...
                            <dd>
                                <ul style="display: none;z-index:2">
                                    ...
                                    <li>Inactive-BRNNE</li>
                                </ul>
                            </dd>
                        </dl>
                        <input name="location" value="" id="location" type ="hidden"/>
                    </td>
                </tr>
                <tr>			
                    <td>
                    <span id="errorspanCheckIn" style="color:#FF0000;"></span>
                    </td>
                 </tr>
            </table>
    ...
    <!-- CHECK OUT FORM-->
    <div class="panel" id="checkOutDiv" <%=checkout%>>
        <h2>Checkout Form:</h2>
        <form name="coutform"  onsubmit="return validateCheckOutForm()" method="post" action="CheckOutFile">
            <table>
                <tr>
                    <td width="230"><h3>File given to:<span style="color: red">*</span></h3></td>
                    <td width= "300">
                        <dl id="sampleOut" class="dropdown">
                            <dt>Select staff</dt>
                            <dd>
                                <ul style="display: none;z-index:2">
                                    <%
                        ...
                        <input name="staffIdOut" value="" id="staffIdOut" type="hidden"/>
                    </td>
                </tr>
                <tr>
                    <td><h3>Date:</h3></td>
                ...
                <tr>
                    <td class="rdate"><h3>Return Date Time:</h3></td>
                    <td>
                ...
                <tr>
                    <td><h3>Reason:</h3></td> 
                    <td><input name="reason" value="" type="text" size="45" class="textbox"/> </td>
                </tr>
                <tr>
                    <td><h3>File location:<span style="color: red">*</span></h3></td>
                    <td>
                ...
                <tr>
                    <td><h3>Specific file location<span style="color: red">*</span></h3></td> 
                    <td>
                ...
                <tr>
                    <td><h3>Specify here(if other)</h3></td>
                    <td><input type="text" name="locationOther" size="45" class="textbox" id="locationOther"/></td>
                </tr>
                <tr>			
                    <td>
                    <span id="errorspanCheckOut" style="color:#FF0000;"></span>
                    </td>
                 </tr>
            </table>
...
function validateCheckInForm(){
        var errorSpan = document.getElementById("errorspanCheckIn");
        errorSpan.innerHTML="";
        var errorString = "";
        
        var employeeNameError=document.forms["cinform"]["staffId"];
        var locationError=document.forms["cinform"]["location"];

        
        if(employeeNameError.value == "" || locationError.value =="")
        {
            errorString +=" ";
        }
    ...
    function validateCheckOutForm(){
        var errorSpan = document.getElementById("errorspanCheckOut");
        errorSpan.innerHTML="";
        var errorString = "";
        var datepass=0;

        var employeeNameError=document.forms["coutform"]["staffIdOut"];
        var locationLevel1Error=document.forms["coutform"]["locationLevel1"];
        var locationLevel2Error=document.forms["coutform"]["locationLevel2"];
        var CheckerOutError=document.forms["coutform"]["CheckerOut"];
        var CheckerReturnError=document.forms["coutform"]["CheckerReturn"];

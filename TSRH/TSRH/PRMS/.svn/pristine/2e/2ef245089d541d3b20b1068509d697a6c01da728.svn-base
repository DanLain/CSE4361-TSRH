...
<%
  session.setAttribute("selectedLink","Phone Record"); 
%>
<html lang="en">
    <head>
	...
	<div class="wrap">
		...
		<div class="container"><div class="ic">More Website Templates at TemplateMonster.com!</div>
			...
			<div class="wrapper indent">
                            <div class="box"     style="height:120px; width:350px;background-color: #F0F0F0;" align="center">
			        <table>
                                    <h3>Select an action to Perform :</h3>
                                    <tr>
                                        <td>
                                            <form action="PatientSearch" method="post">
                                                <input type="submit" class="blue button" align="center" style="width:310px" value="Create a new conversation record" />
                                            </form>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td>
                                            <form action="phoneEditSelector.jsp" method="post">
                                                <input type="submit" class="blue button" align="center" style="width:310px" value="View an existing conversation record" />
                                            </form>
                                        </td>
                                    </tr>
                                </table>

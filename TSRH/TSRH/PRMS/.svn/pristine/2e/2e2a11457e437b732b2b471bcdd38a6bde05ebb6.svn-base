                            ...
                            <article class="col-1">
                                ...
                                <div id="tbltxt">
                                   ...
                                   <tr>
                                        ...
                                        %>
                                        <tr>
                                            <td style ="word-wrap:break-word;"class="fid"><%= testFiles.getPatientId()%></td>
                                            <td style ="word-wrap:break-word;"class="name"><%= testFiles.getPatientName()%></a></td>
                                            <td style ="word-wrap:break-word;"class="pname"><%= testFiles.getTestName()%></a></td>
                                            <td style ="word-wrap:break-word;"class="pedate"><%=testFiles.getTestRequesterName()%></td>
                                            <td style ="word-wrap:break-word;"class="location"><%=testFiles.getUserId()%></td>
                                            <td style ="word-wrap:break-word;"class="reason"><%= testFiles.getStaffName()%></td>
                                            <td style ="word-wrap:break-word;"class="staffname"><%=testFiles.getRequestedDate()%></td>
                                            <td style ="word-wrap:break-word;"class="staffname"><%=testFiles.getExpectedDate()%></td>
                                        </tr>
                                        <%
                                                }
                                            } else {

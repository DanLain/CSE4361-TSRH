<%-- 
    Document   : editVacationConfirmmessage
    Created on : Apr 22, 2013, 11:39:24 AM
    Author     : Sravan
--%>
                ...
                <div class="container"><div class="ic">More Website Templates at TemplateMonster.com!</div>
                    <div class="inside">
                         <div class="wrapper indent">
                            <article class="col-1">
        <%  if(session.getAttribute("editvacation")=="sucess"){%>
       <div class="box"  style="width:500px;background-color: #F0F0F0;" align="center">
       <h2 color="green">Vacation has been updated successfully</h2> 
       <%} else {%>
       <h2 color="red">Problem occurred while updating the vacation</h2> <%}%>

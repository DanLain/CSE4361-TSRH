...
String tempo = " ";
String pid="";
pid= Controller.getCurrentPatient().getPatientId();
...
<td colspan=2>  <input type="button" class="blue button" onclick="window.location = '/TSRH/testrequest.jsp?pid=<%=pid%> '" value="OK" >
</td>
<tr>
</table>
</div>

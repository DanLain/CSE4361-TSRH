...
public class SQLAccess implements DBAccess {
    ...
    static DBConfig cfg = new DBConfig();
    
    static String ipAddress = cfg.getProperty("ipAddress");
    static String dbPort = cfg.getProperty("mDbPort");
    static String dbName = cfg.getProperty("mDbName");
    
    private static String connectStr = "jdbc:mysql://" + ipAddress + ":" + dbPort + "/" + dbName;
    private static String userName = cfg.getProperty("mDbUser");
    private static String passWord = cfg.getProperty("mDbPwds");

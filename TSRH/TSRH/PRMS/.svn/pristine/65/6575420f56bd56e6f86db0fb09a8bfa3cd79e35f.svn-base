...
public class AddNote extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
        ...
        if (request.getParameter("date") != null) {
            ...
            int newID = NoteController.addPatientNote(patientId, newNote);
            
            HashSet<Integer> noteID = (HashSet<Integer>)request.getSession().getAttribute("noteID");
            
            noteID.add(newID);

            response.sendRedirect("?page=PatientProfile&patient=" + patientId);
        }

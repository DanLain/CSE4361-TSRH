<%-- 
    Document   : editVacation
    Created on : Apr 21, 2013, 7:38:06 PM
    Author     : Sravan
--%>
...
<script>
    ...
    %>
     ...
     <%  
             ...
             String fromdate = request.getParameter("vacationFrom");
             String todate = request.getParameter("vacationTo");
             String forward = request.getParameter("vacationForward");
             String msg = request.getParameter("vacationMsg");
             
           
    %>
    <jsp:useBean id="Controller" class="controller.Controller" scope="session" />
    <body id="page1" onLoad="upgradepicker()">
        <a href="javascript:$.pageslide({ direction: 'right', href: 'help/SetAlert.html' })" class="first">help</a>
        <div class="wrap">
            <!-- header -->
                ...
                <div class="container"><div class="ic">More Website Templates at TemplateMonster.com!</div>
                    <div class="inside">
                        <div class="wrapper indent">
                            ...
                            <article class="col-1">
                                ...
                                <p>
                                <form name="form1" method="post" onSubmit="return validateForm()" action="EditVac.jsp">
                                    <input type="hidden" name="vacationId" value="<%=vId%>"</input>
                                    <table width="800" >
                                          <tr>
                                            <td><h3><font color="red">*</font>Vacation Title:</h3></td>
                                            <td width="200"><p>
                                                    <input type="text" class="textbox" name="vacationTitle" maxlength="50" id="vacationTitle" style="height:25px;width:250px " value="<%=title %>">
                                               <td> <font size="5" color="white" id="msg0"></font></td>
                                                </p>
                                                <p>
                                                    <label for="vacationTitle"></label>
                                                </p></td>
                                        </tr>
                                            <tr>
                                                <td><h3><font color="red">*</font>Vacation from:</h3></td>
                                                <td><p>
                                                        <input name="fromdate"  type="text" id="alertdate" value="<%=fromdate %>" />
                                                        <td>
                                         ...
                                         <tr>
                                                ...
                                                <td><p>
                                                        <input name="todate"  type="text" id="alertdate1" value="<%=todate %>"/>
                                                        <td>
                    ...
                    con = (Connection) DriverManager.getConnection(dbUrl,dbUserName,dbPassword);
                                         ...
                                         <tr>
                                            ...
                                            <td width="200"><p>
                                                    <textarea name="vacationMessage" class="textbox" maxlength="500" cols="30" rows="6" style="height:100px;width:250px;resize:none"><%=msg %></textarea>
                                    ...
                                    <table>
                                        ...
                                        <tr>
                                            <td>&nbsp;</td>
                                            <td  colspan="2"><h3><input type="submit" align="right" class="blue button"  value="Update Vacation">   </h3>       </tr>
                                      </table>
                                </form>
                                </p>
                            </article>

...
implements MySQLCmd
{
 ...
 public GetReportFiles(String startTime, String endTime, String returnType)
 {            
     try
     {
 ...
 private String buildQuery()
 {
     ...
     selectSQLBuilder.addSelectColumn(" t.patientid_testrequest, t.testname, t.testrequestername ,t.userid,t.istesttaken,t.testrequestdate,t.expectedresultdate");
